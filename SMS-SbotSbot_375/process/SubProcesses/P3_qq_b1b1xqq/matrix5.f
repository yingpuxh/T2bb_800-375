...
C     
C     Process: u u~ > b1 b1~ c c~ WEIGHTED<=4 @3
C     Process: u u~ > b1 b1~ d d~ WEIGHTED<=4 @3
C     Process: u u~ > b1 b1~ s s~ WEIGHTED<=4 @3
C     Process: c c~ > b1 b1~ u u~ WEIGHTED<=4 @3
C     Process: c c~ > b1 b1~ d d~ WEIGHTED<=4 @3
C     Process: c c~ > b1 b1~ s s~ WEIGHTED<=4 @3
C     Process: d d~ > b1 b1~ u u~ WEIGHTED<=4 @3
C     Process: d d~ > b1 b1~ c c~ WEIGHTED<=4 @3
C     Process: d d~ > b1 b1~ s s~ WEIGHTED<=4 @3
C     Process: s s~ > b1 b1~ u u~ WEIGHTED<=4 @3
C     Process: s s~ > b1 b1~ c c~ WEIGHTED<=4 @3
C     Process: s s~ > b1 b1~ d d~ WEIGHTED<=4 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,5),W(1,9),GC_7,AMP(8))
      CALL FFV1_1(W(1,5),W(1,7),GC_7,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,6),W(1,4),W(1,9),GC_7,AMP(9))
      CALL FFV1_2(W(1,1),W(1,8),GC_7,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,2),W(1,9),GC_7,AMP(10))
      CALL FFV1_2(W(1,1),W(1,9),GC_7,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,4),W(1,2),W(1,8),GC_7,AMP(11))
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -AMP(11))
      JAMP(6,1)=+1D0/4D0*(+1D0/3D0*AMP(8)+1D0/3D0*AMP(9)+1D0/3D0

...
C     
C     Process: c c~ > b1 b1~ b b~ WEIGHTED<=4 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 7
      ...
      CALL VSS1_2(W(1,7),W(1,3),GC_71,MDL_MSD3,MDL_WSD3,W(1,5))
C     Amplitude(s) for diagram number 8
      CALL FFS1_2_0(W(1,6),W(1,9),W(1,5),GC_108,GC_513,AMP(8))
...
C     Amplitude(s) for diagram number 12
      CALL VSS1_0(W(1,11),W(1,4),W(1,5),GC_71,AMP(13))
...
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,14),W(1,2),W(1,11),GC_7,AMP(17))
      CALL FFV1_2(W(1,1),W(1,11),GC_7,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,14),W(1,2),W(1,8),GC_7,AMP(18))
      CALL IXXXXX(P(0,5),MDL_MB,NHEL(5),-1*IC(5),W(1,14))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1D0/9D0*AMP(20)+1D0/9D0*AMP(21)+1D0/9D0*AMP(22))
      JAMP(3,1)=+1D0/4D0*(-AMP(4)-AMP(5)+IMAG1*AMP(7)-AMP(8)-AMP(9)

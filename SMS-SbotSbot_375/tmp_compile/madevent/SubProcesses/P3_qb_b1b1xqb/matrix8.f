...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION MATRIX8(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ *AMP(7)+AMP(10)-1D0/3D0*AMP(17)-1D0/3D0*AMP(18)-AMP(21)-AMP(22))
      JAMP(2,1)=+1D0/4D0*(+AMP(1)-IMAG1*AMP(3)-1D0/3D0*AMP(4)-1D0/3D0
     $ *AMP(5)-1D0/3D0*AMP(6)+AMP(11)+AMP(15)+AMP(16)+AMP(18)-1D0/3D0
     $ *AMP(19)-1D0/3D0*AMP(20)+1D0/3D0*AMP(21)+1D0/3D0*AMP(22))
      JAMP(3,1)=+1D0/4D0*(+AMP(2)+IMAG1*AMP(3)-1D0/3D0*AMP(8)-1D0/3D0
     $ *AMP(9)-1D0/3D0*AMP(10)+AMP(12)+AMP(13)+AMP(14)+AMP(17)-1D0/3D0
     $ *AMP(19)-1D0/3D0*AMP(20)+1D0/3D0*AMP(21)+1D0/3D0*AMP(22))
      JAMP(4,1)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)+1D0/9D0*AMP(4)
     ...
     $ +1D0/9D0*AMP(20)-1D0/9D0*AMP(21)-1D0/9D0*AMP(22))
      JAMP(5,1)=+1D0/4D0*(+AMP(4)+AMP(5)-IMAG1*AMP(7)+AMP(8)+AMP(9)
     ...
     $ +1D0/9D0*AMP(18))
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          ENDDO
          DO N = 1, NAMPSO
            IF (CHOSEN_SO_CONFIGS(SQSOINDEX8(M,N))) THEN
              MATRIX8 = MATRIX8 + ZTEMP*DCONJG(JAMP(I,N))/DENOM(I)
            ENDIF
          ENDDO
        ENDDO
      ENDDO

...
C     
C     Process: g g > b1 b1~ WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VVSS1_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_18,AMP(1))
      CALL VVSS1_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_18,AMP(2))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_6,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_71,AMP(3))
      CALL VSS1_2(W(1,1),W(1,3),GC_71,MDL_MSD3,MDL_WSD3,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,2),W(1,4),W(1,5),GC_71,AMP(4))
      CALL VSS1_3(W(1,1),W(1,3),GC_79,MDL_MSD6,MDL_WSD6,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,2),W(1,4),W(1,5),GC_73,AMP(5))
      CALL VSS1_3(W(1,1),W(1,4),GC_71,MDL_MSD3,MDL_WSD3,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL VSS1_0(W(1,2),W(1,5),W(1,3),GC_71,AMP(6))
      CALL VSS1_3(W(1,1),W(1,4),GC_73,MDL_MSD6,MDL_WSD6,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL VSS1_0(W(1,2),W(1,3),W(1,5),GC_79,AMP(7))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+AMP(2)-IMAG1*AMP(3)+AMP(4)+AMP(5)
      JAMP(2,1)=+AMP(1)+IMAG1*AMP(3)+AMP(6)+AMP(7)

...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,5),W(1,2),GC_7,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 5
      CALL FFS1_2_0(W(1,5),W(1,8),W(1,6),GC_108,GC_513,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFS1_2_0(W(1,5),W(1,8),W(1,10),GC_528,GC_533,AMP(6))
      CALL VSS1_3(W(1,1),W(1,4),GC_71,MDL_MSD3,MDL_WSD3,W(1,10))
      CALL FFS1_2_2(W(1,5),W(1,3),GC_108,GC_513,MDL_MGO,MDL_WGO,W(1,6))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(1,2),W(1,1),GC_7,MDL_MB,ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL FFS1_2_0(W(1,6),W(1,11),W(1,4),GC_513,GC_108,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,5),W(1,11),W(1,7),GC_7,AMP(12))
...
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,5),W(1,2),W(1,9),GC_7,AMP(15))
      CALL FFV1_0(W(1,5),W(1,2),W(1,7),GC_7,AMP(16))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*(+1D0/3D0*AMP(7)+1D0/3D0*AMP(8)-AMP(9)-AMP(10)
     $ +1D0/3D0*AMP(11)-AMP(12)-IMAG1*AMP(14)-AMP(16))
      JAMP(2,1)=+1D0/2D0*(+1D0/3D0*AMP(1)-AMP(2)-AMP(11)+1D0/3D0
     $ *AMP(12)-IMAG1*AMP(13))
      JAMP(3,1)=+1D0/2D0*(+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)-AMP(5)-AMP(6)
     $ -AMP(7)-AMP(8)+1D0/3D0*AMP(9)+1D0/3D0*AMP(10)+IMAG1*AMP(13)+1D0
     $ /3D0*AMP(16)+1D0/3D0*AMP(15))
      JAMP(4,1)=+1D0/2D0*(-AMP(1)+1D0/3D0*AMP(2)-AMP(3)-AMP(4)+1D0/3D0

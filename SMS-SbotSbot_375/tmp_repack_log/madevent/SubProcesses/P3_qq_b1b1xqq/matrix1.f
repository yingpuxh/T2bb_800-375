...
C     
C     Process: u u > b1 b1~ u u WEIGHTED<=4 @3
C     Process: c c > b1 b1~ c c WEIGHTED<=4 @3
C     Process: d d > b1 b1~ d d WEIGHTED<=4 @3
C     Process: s s > b1 b1~ s s WEIGHTED<=4 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      PARAMETER (NWAVEFUNCS=11, NCOLOR=6)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,2),W(1,6),GC_7,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 1
      CALL VVSS1_0(W(1,7),W(1,8),W(1,4),W(1,3),GC_18,AMP(1))
      CALL VVSS1_0(W(1,7),W(1,8),W(1,4),W(1,3),GC_18,AMP(2))
      CALL VSS1_2(W(1,7),W(1,3),GC_71,MDL_MSD3,MDL_WSD3,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,8),W(1,4),W(1,9),GC_71,AMP(3))
      CALL VSS1_3(W(1,7),W(1,3),GC_79,MDL_MSD6,MDL_WSD6,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,8),W(1,4),W(1,9),GC_73,AMP(4))
      CALL VSS1_3(W(1,7),W(1,4),GC_71,MDL_MSD3,MDL_WSD3,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,8),W(1,9),W(1,3),GC_71,AMP(5))
      CALL VSS1_3(W(1,7),W(1,4),GC_73,MDL_MSD6,MDL_WSD6,W(1,9))
C     Amplitude(s) for diagram number 5
      CALL VSS1_0(W(1,8),W(1,3),W(1,9),GC_79,AMP(6))
      CALL VSS1P0_1(W(1,4),W(1,3),GC_71,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 6
      CALL VVV1_0(W(1,7),W(1,8),W(1,9),GC_6,AMP(7))
      CALL FFV1_2(W(1,2),W(1,7),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,10),W(1,6),W(1,9),GC_7,AMP(8))
      CALL FFV1_1(W(1,6),W(1,7),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,10),W(1,9),GC_7,AMP(9))
      CALL FFV1P0_3(W(1,1),W(1,6),GC_7,ZERO,ZERO,W(1,10))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_7,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL VVSS1_0(W(1,10),W(1,7),W(1,4),W(1,3),GC_18,AMP(10))
      CALL VVSS1_0(W(1,10),W(1,7),W(1,4),W(1,3),GC_18,AMP(11))
      CALL VSS1_2(W(1,10),W(1,3),GC_71,MDL_MSD3,MDL_WSD3,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL VSS1_0(W(1,7),W(1,4),W(1,11),GC_71,AMP(12))
      CALL VSS1_3(W(1,10),W(1,3),GC_79,MDL_MSD6,MDL_WSD6,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL VSS1_0(W(1,7),W(1,4),W(1,11),GC_73,AMP(13))
      CALL VSS1_3(W(1,10),W(1,4),GC_71,MDL_MSD3,MDL_WSD3,W(1,11))
C     Amplitude(s) for diagram number 12
      CALL VSS1_0(W(1,7),W(1,11),W(1,3),GC_71,AMP(14))
      CALL VSS1_3(W(1,10),W(1,4),GC_73,MDL_MSD6,MDL_WSD6,W(1,11))
C     Amplitude(s) for diagram number 13
      CALL VSS1_0(W(1,7),W(1,3),W(1,11),GC_79,AMP(15))
C     Amplitude(s) for diagram number 14
      CALL VVV1_0(W(1,10),W(1,7),W(1,9),GC_6,AMP(16))
      CALL FFV1_2(W(1,2),W(1,10),GC_7,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,11),W(1,5),W(1,9),GC_7,AMP(17))
      CALL FFV1_1(W(1,5),W(1,10),GC_7,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,2),W(1,11),W(1,9),GC_7,AMP(18))
      CALL FFV1_2(W(1,1),W(1,7),GC_7,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,11),W(1,6),W(1,9),GC_7,AMP(19))
      CALL FFV1_2(W(1,1),W(1,9),GC_7,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,11),W(1,6),W(1,7),GC_7,AMP(20))
      CALL FFV1_2(W(1,1),W(1,8),GC_7,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,7),W(1,5),W(1,9),GC_7,AMP(21))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,11),W(1,5),W(1,8),GC_7,AMP(22))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/4D0*(-AMP(2)-AMP(3)-AMP(4)+IMAG1*AMP(7)-AMP(8)
     $ -1D0/3D0*AMP(10)-1D0/3D0*AMP(11)-1D0/3D0*AMP(12)-1D0/3D0*AMP(13)
     $ -1D0/3D0*AMP(14)-1D0/3D0*AMP(15)-1D0/3D0*AMP(19)-1D0/3D0*AMP(20)
     $ -AMP(22))
      JAMP(2,1)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(3)
     $ +1D0/3D0*AMP(4)+1D0/3D0*AMP(5)+1D0/3D0*AMP(6)+AMP(11)+AMP(12)
     $ +AMP(13)-IMAG1*AMP(16)+AMP(17)+AMP(20)+1D0/3D0*AMP(21)+1D0/3D0
     $ *AMP(22))
      JAMP(3,1)=+1D0/4D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(2)+1D0/3D0*AMP(3)
     $ +1D0/3D0*AMP(4)+1D0/3D0*AMP(5)+1D0/3D0*AMP(6)+1D0/3D0*AMP(8)
     $ +1D0/3D0*AMP(9)+AMP(10)+AMP(14)+AMP(15)+IMAG1*AMP(16)+AMP(18)
     $ +AMP(19))
      JAMP(4,1)=+1D0/4D0*(-AMP(1)-AMP(5)-AMP(6)-IMAG1*AMP(7)-AMP(9)
     $ -1D0/3D0*AMP(10)-1D0/3D0*AMP(11)-1D0/3D0*AMP(12)-1D0/3D0*AMP(13)
     $ -1D0/3D0*AMP(14)-1D0/3D0*AMP(15)-1D0/3D0*AMP(17)-1D0/3D0*AMP(18)
     $ -AMP(21))
      JAMP(5,1)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/9D0*AMP(2)-1D0/9D0*AMP(3)
     $ -1D0/9D0*AMP(4)-1D0/9D0*AMP(5)-1D0/9D0*AMP(6)-1D0/9D0*AMP(8)
     $ -1D0/9D0*AMP(9)-1D0/3D0*AMP(17)-1D0/3D0*AMP(18)-1D0/3D0*AMP(19)
     $ -1D0/3D0*AMP(20)-1D0/9D0*AMP(21)-1D0/9D0*AMP(22))
      JAMP(6,1)=+1D0/4D0*(+1D0/3D0*AMP(8)+1D0/3D0*AMP(9)+1D0/9D0
     $ *AMP(10)+1D0/9D0*AMP(11)+1D0/9D0*AMP(12)+1D0/9D0*AMP(13)+1D0
     $ /9D0*AMP(14)+1D0/9D0*AMP(15)+1D0/9D0*AMP(17)+1D0/9D0*AMP(18)
     $ +1D0/9D0*AMP(19)+1D0/9D0*AMP(20)+1D0/3D0*AMP(21)+1D0/3D0*AMP(22)
     $ )

...
C     
C     Process: u u~ > b1 b1~ g WEIGHTED<=3 @2
C     Process: c c~ > b1 b1~ g WEIGHTED<=3 @2
C     Process: d d~ > b1 b1~ g WEIGHTED<=3 @2
C     Process: s s~ > b1 b1~ g WEIGHTED<=3 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV1_2(W(1,1),W(1,5),GC_7,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,8),W(1,4),W(1,6),GC_71,AMP(2))
      CALL VSS1_3(W(1,5),W(1,3),GC_79,MDL_MSD6,MDL_WSD6,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,8),W(1,4),W(1,6),GC_73,AMP(3))
      CALL VSS1_3(W(1,5),W(1,4),GC_71,MDL_MSD3,MDL_WSD3,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,8),W(1,6),W(1,3),GC_71,AMP(4))
      CALL VSS1_3(W(1,5),W(1,4),GC_73,MDL_MSD6,MDL_WSD6,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL VSS1_0(W(1,8),W(1,3),W(1,6),GC_79,AMP(5))
      CALL FFV1_1(W(1,2),W(1,5),GC_7,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,1),W(1,6),W(1,7),GC_7,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL VVV1_0(W(1,5),W(1,8),W(1,7),GC_6,AMP(7))
      CALL VVSS1P0_1(W(1,5),W(1,4),W(1,3),GC_18,ZERO,ZERO,W(1,8))
      CALL VVSS1P0_1(W(1,5),W(1,4),W(1,3),GC_18,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,1),W(1,2),W(1,8),GC_7,AMP(8))
      CALL FFV1_0(W(1,1),W(1,2),W(1,7),GC_7,AMP(9))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*(-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)-1D0/3D0*AMP(4)
     $ -1D0/3D0*AMP(5)-1D0/3D0*AMP(9)-1D0/3D0*AMP(8))
      JAMP(2,1)=+1D0/2D0*(+AMP(1)+AMP(2)+AMP(3)-IMAG1*AMP(7)+AMP(8))
      JAMP(3,1)=+1D0/2D0*(+AMP(4)+AMP(5)+AMP(6)+IMAG1*AMP(7)+AMP(9))
      JAMP(4,1)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(6))

...
C     
C     Process: u c~ > b1 b1~ u c~ WEIGHTED<=4 @3
C     Process: u d~ > b1 b1~ u d~ WEIGHTED<=4 @3
C     Process: u s~ > b1 b1~ u s~ WEIGHTED<=4 @3
C     Process: c u~ > b1 b1~ c u~ WEIGHTED<=4 @3
C     Process: c d~ > b1 b1~ c d~ WEIGHTED<=4 @3
C     Process: c s~ > b1 b1~ c s~ WEIGHTED<=4 @3
C     Process: d u~ > b1 b1~ d u~ WEIGHTED<=4 @3
C     Process: d c~ > b1 b1~ d c~ WEIGHTED<=4 @3
C     Process: d s~ > b1 b1~ d s~ WEIGHTED<=4 @3
C     Process: s u~ > b1 b1~ s u~ WEIGHTED<=4 @3
C     Process: s c~ > b1 b1~ s c~ WEIGHTED<=4 @3
C     Process: s d~ > b1 b1~ s d~ WEIGHTED<=4 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      PARAMETER (NWAVEFUNCS=9, NCOLOR=6)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_2(W(1,6),W(1,7),GC_7,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,2),W(1,9),GC_7,AMP(8))
      CALL FFV1_1(W(1,2),W(1,7),GC_7,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,6),W(1,4),W(1,9),GC_7,AMP(9))
      CALL FFV1_2(W(1,1),W(1,8),GC_7,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,5),W(1,9),GC_7,AMP(10))
      CALL FFV1_2(W(1,1),W(1,9),GC_7,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,4),W(1,5),W(1,8),GC_7,AMP(11))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/4D0*(-1D0/3D0*AMP(8)-1D0/3D0*AMP(9)-1D0/3D0
     $ *AMP(10)-1D0/3D0*AMP(11))
      JAMP(2,1)=+1D0/4D0*(+AMP(1)+AMP(5)+AMP(6)+IMAG1*AMP(7)+AMP(9)
     $ +AMP(10))
      JAMP(3,1)=+1D0/4D0*(+AMP(2)+AMP(3)+AMP(4)-IMAG1*AMP(7)+AMP(8)
     $ +AMP(11))
      JAMP(4,1)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)
     $ -1D0/3D0*AMP(4)-1D0/3D0*AMP(5)-1D0/3D0*AMP(6)-1D0/3D0*AMP(8)
     $ -1D0/3D0*AMP(9))
      JAMP(5,1)=+1D0/4D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)
     $ -1D0/3D0*AMP(4)-1D0/3D0*AMP(5)-1D0/3D0*AMP(6)-1D0/3D0*AMP(10)
     $ -1D0/3D0*AMP(11))
      JAMP(6,1)=+1D0/4D0*(+1D0/9D0*AMP(1)+1D0/9D0*AMP(2)+1D0/9D0*AMP(3)
     $ +1D0/9D0*AMP(4)+1D0/9D0*AMP(5)+1D0/9D0*AMP(6)+1D0/9D0*AMP(8)
     $ +1D0/9D0*AMP(9)+1D0/9D0*AMP(10)+1D0/9D0*AMP(11))

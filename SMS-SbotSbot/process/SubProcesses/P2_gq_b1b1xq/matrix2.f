...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,5),W(1,2),GC_7,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_1(W(1,2),W(1,1),GC_7,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,5),W(1,6),W(1,7),GC_7,AMP(6))
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,5),W(1,2),W(1,8),GC_7,AMP(8))
      CALL FFV1_0(W(1,5),W(1,2),W(1,7),GC_7,AMP(9))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*(-AMP(4)-AMP(5)-AMP(6)-IMAG1*AMP(7)-AMP(9))
      JAMP(2,1)=+1D0/2D0*(+1D0/3D0*AMP(1)+1D0/3D0*AMP(6))
      JAMP(3,1)=+1D0/2D0*(+1D0/3D0*AMP(2)+1D0/3D0*AMP(3)+1D0/3D0*AMP(4)
     $ +1D0/3D0*AMP(5)+1D0/3D0*AMP(9)+1D0/3D0*AMP(8))
      JAMP(4,1)=+1D0/2D0*(-AMP(1)-AMP(2)-AMP(3)+IMAG1*AMP(7)-AMP(8))

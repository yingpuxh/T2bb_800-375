...
C     
C     Process: b b~ > b1 b1~ c c~ WEIGHTED<=4 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,6),W(1,5),GC_7,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 8
      CALL FFS1_2_0(W(1,1),W(1,9),W(1,2),GC_108,GC_513,AMP(8))
      CALL VSS1_3(W(1,7),W(1,3),GC_79,MDL_MSD6,MDL_WSD6,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFS1_2_0(W(1,1),W(1,9),W(1,15),GC_528,GC_533,AMP(9))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1_2(W(1,6),W(1,8),GC_7,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 17
     ...
     $ ,8))
      CALL OXXXXX(P(0,1),MDL_MB,NHEL(1),-1*IC(1),W(1,14))
      CALL FFS1_2C1_1(W(1,14),W(1,3),GC_108,GC_513,MDL_MGO,MDL_WGO,W(1
     $ ,4))
      CALL FFS1_3(W(1,6),W(1,4),GC_587,MDL_MSU1,MDL_WSU2,W(1,14))
C     Amplitude(s) for diagram number 18
      CALL FFS2_0(W(1,8),W(1,5),W(1,14),GC_587,AMP(19))
      CALL FFS2_3(W(1,6),W(1,4),GC_518,MDL_MSU4,MDL_WSU5,W(1,14))
C     Amplitude(s) for diagram number 19
      CALL FFS1_0(W(1,8),W(1,5),W(1,14),GC_518,AMP(20))
      CALL FFS1_3(W(1,6),W(1,9),GC_587,MDL_MSU1,MDL_WSU2,W(1,14))
C     Amplitude(s) for diagram number 20
      CALL FFS2_0(W(1,12),W(1,5),W(1,14),GC_587,AMP(21))
      CALL FFS2_3(W(1,6),W(1,9),GC_518,MDL_MSU4,MDL_WSU5,W(1,14))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1D0/9D0*AMP(20)+1D0/9D0*AMP(21)+1D0/9D0*AMP(22))
      JAMP(4,1)=+1D0/4D0*(-AMP(2)-IMAG1*AMP(3)+1D0/3D0*AMP(8)+1D0/3D0
     $ *AMP(9)+1D0/3D0*AMP(10)-AMP(12)-AMP(13)-AMP(14)-AMP(17)+1D0/3D0
     $ *AMP(19)+1D0/3D0*AMP(20)-1D0/3D0*AMP(21)-1D0/3D0*AMP(22))
      JAMP(5,1)=+1D0/4D0*(-AMP(1)+IMAG1*AMP(3)+1D0/3D0*AMP(4)+1D0/3D0

...
C     
C     Process: b b~ > b1 b1~ WEIGHTED<=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_71,AMP(1))
      CALL FFS1_2_2(W(1,1),W(1,3),GC_108,GC_513,MDL_MGO,MDL_WGO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFS1_2_0(W(1,5),W(1,2),W(1,4),GC_513,GC_108,AMP(2))

...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
      ...
      REAL*8 FUNCTION MATRIX7(P,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,1),W(1,5),GC_7,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_7,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,14),W(1,5),W(1,11),GC_7,AMP(17))
      CALL FFV1_2(W(1,1),W(1,11),GC_7,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,14),W(1,5),W(1,8),GC_7,AMP(18))
     ...
     $ ,4))
      CALL FFS1_3(W(1,1),W(1,4),GC_587,MDL_MSD1,MDL_WSD2,W(1,14))
C     Amplitude(s) for diagram number 18
      CALL FFS2_0(W(1,8),W(1,5),W(1,14),GC_587,AMP(19))
      CALL FFS2_3(W(1,1),W(1,4),GC_518,MDL_MSD4,MDL_WSD5,W(1,14))
C     Amplitude(s) for diagram number 19
      CALL FFS1_0(W(1,8),W(1,5),W(1,14),GC_518,AMP(20))
      CALL FFS1_3(W(1,1),W(1,9),GC_587,MDL_MSD1,MDL_WSD2,W(1,14))
C     Amplitude(s) for diagram number 20
      CALL FFS2_0(W(1,12),W(1,5),W(1,14),GC_587,AMP(21))
      CALL FFS2_3(W(1,1),W(1,9),GC_518,MDL_MSD4,MDL_WSD5,W(1,14))
C     Amplitude(s) for diagram number 21
      CALL FFS1_0(W(1,12),W(1,5),W(1,14),GC_518,AMP(22))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/4D0*(-AMP(2)-IMAG1*AMP(3)+1D0/3D0*AMP(8)+1D0/3D0
     ...
     $ -1D0/9D0*AMP(20)+1D0/9D0*AMP(21)+1D0/9D0*AMP(22))
      JAMP(4,1)=+1D0/4D0*(-AMP(1)+IMAG1*AMP(3)+1D0/3D0*AMP(4)+1D0/3D0
     $ *AMP(5)+1D0/3D0*AMP(6)-AMP(11)-AMP(15)-AMP(16)-AMP(18)+1D0/3D0
     $ *AMP(19)+1D0/3D0*AMP(20)-1D0/3D0*AMP(21)-1D0/3D0*AMP(22))
      JAMP(5,1)=+1D0/4D0*(-1D0/9D0*AMP(1)-1D0/9D0*AMP(2)+1D0/3D0*AMP(4)
     ...
     $ *AMP(7)-AMP(10)+1D0/3D0*AMP(17)+1D0/3D0*AMP(18)+AMP(21)+AMP(22))
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          ENDDO
          DO N = 1, NAMPSO
            IF (CHOSEN_SO_CONFIGS(SQSOINDEX7(M,N))) THEN
              MATRIX7 = MATRIX7 + ZTEMP*DCONJG(JAMP(I,N))/DENOM(I)
            ENDIF
          ENDDO
        ENDDO
      ENDDO

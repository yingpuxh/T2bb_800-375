...
C     
C     Process: g b > b1 b1~ b WEIGHTED<=3 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV1_2(W(1,2),W(1,1),GC_7,MDL_MB,ZERO,W(1,6))
      CALL VSS1P0_1(W(1,4),W(1,3),GC_71,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,5),W(1,7),GC_7,AMP(1))
      CALL FFS1_2_1(W(1,5),W(1,4),GC_513,GC_108,MDL_MGO,MDL_WGO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFS1_2_0(W(1,6),W(1,8),W(1,3),GC_108,GC_513,AMP(2))
      CALL VSS1_2(W(1,1),W(1,3),GC_71,MDL_MSD3,MDL_WSD3,W(1,6))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_7,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,9),W(1,4),W(1,6),GC_71,AMP(3))
      CALL VSS1_3(W(1,1),W(1,3),GC_79,MDL_MSD6,MDL_WSD6,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,9),W(1,4),W(1,10),GC_73,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFS1_2_0(W(1,2),W(1,8),W(1,6),GC_108,GC_513,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFS1_2_0(W(1,2),W(1,8),W(1,10),GC_528,GC_533,AMP(6))
      CALL VSS1_3(W(1,1),W(1,4),GC_71,MDL_MSD3,MDL_WSD3,W(1,10))
      CALL FFS1_2_2(W(1,2),W(1,3),GC_108,GC_513,MDL_MGO,MDL_WGO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFS1_2_0(W(1,6),W(1,5),W(1,10),GC_513,GC_108,AMP(7))
      CALL VSS1_3(W(1,1),W(1,4),GC_73,MDL_MSD6,MDL_WSD6,W(1,11))
C     Amplitude(s) for diagram number 8
      CALL FFS1_2_0(W(1,6),W(1,5),W(1,11),GC_533,GC_528,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VSS1_0(W(1,9),W(1,10),W(1,3),GC_71,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL VSS1_0(W(1,9),W(1,3),W(1,11),GC_79,AMP(10))
      CALL FFV1_1(W(1,5),W(1,1),GC_7,MDL_MB,ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL FFS1_2_0(W(1,6),W(1,11),W(1,4),GC_513,GC_108,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,2),W(1,11),W(1,7),GC_7,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,6),W(1,8),W(1,1),GC_8,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL VVV1_0(W(1,1),W(1,9),W(1,7),GC_6,AMP(14))
      CALL VVSS1P0_1(W(1,1),W(1,4),W(1,3),GC_18,ZERO,ZERO,W(1,9))
      CALL VVSS1P0_1(W(1,1),W(1,4),W(1,3),GC_18,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,2),W(1,5),W(1,9),GC_7,AMP(15))
      CALL FFV1_0(W(1,2),W(1,5),W(1,7),GC_7,AMP(16))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+1D0/2D0*(+AMP(1)-1D0/3D0*AMP(2)+AMP(3)+AMP(4)-1D0/3D0
     $ *AMP(5)-1D0/3D0*AMP(6)-IMAG1*AMP(14)+AMP(15))
      JAMP(2,1)=+1D0/2D0*(-1D0/3D0*AMP(3)-1D0/3D0*AMP(4)+AMP(5)+AMP(6)
     $ +AMP(7)+AMP(8)-1D0/3D0*AMP(9)-1D0/3D0*AMP(10)-IMAG1*AMP(13)-1D0
     $ /3D0*AMP(16)-1D0/3D0*AMP(15))
      JAMP(3,1)=+1D0/2D0*(-1D0/3D0*AMP(1)+AMP(2)+AMP(11)-1D0/3D0
     $ *AMP(12)+IMAG1*AMP(13))
      JAMP(4,1)=+1D0/2D0*(-1D0/3D0*AMP(7)-1D0/3D0*AMP(8)+AMP(9)+AMP(10)
     $ -1D0/3D0*AMP(11)+AMP(12)+IMAG1*AMP(14)+AMP(16))

...
C     
C     Process: b b~ > b1 b1~ d d~ WEIGHTED<=4 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 17
     ...
     $ ,4))
      CALL FFS1_3(W(1,6),W(1,4),GC_587,MDL_MSD1,MDL_WSD1,W(1,14))
C     Amplitude(s) for diagram number 18
      CALL FFS2_0(W(1,8),W(1,5),W(1,14),GC_587,AMP(19))
      CALL FFS2_3(W(1,6),W(1,4),GC_518,MDL_MSD4,MDL_WSD4,W(1,14))
C     Amplitude(s) for diagram number 19
      CALL FFS1_0(W(1,8),W(1,5),W(1,14),GC_518,AMP(20))
      CALL FFS1_3(W(1,6),W(1,9),GC_587,MDL_MSD1,MDL_WSD1,W(1,14))
C     Amplitude(s) for diagram number 20
      CALL FFS2_0(W(1,12),W(1,5),W(1,14),GC_587,AMP(21))
      CALL FFS2_3(W(1,6),W(1,9),GC_518,MDL_MSD4,MDL_WSD4,W(1,14))
